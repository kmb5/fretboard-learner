...
- Interval training? Computer tells you a root note and an interval and you have to play the interval (eg. major third of E)
   (this is to avoid having to check multiple notes at once)
'''
